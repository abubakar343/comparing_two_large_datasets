...
sg_emails_df = pd.read_csv('first_file.csv',dtype={'Email Address': str},low_memory=False)
master_emails_df = pd.read_csv('second_file.csv',dtype={'Email': str},low_memory=False)
